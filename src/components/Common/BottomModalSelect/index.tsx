...
class BottomModalSelect extends Component<Props, State> {
  ...
  constructor(props: Props) {
    ...
    this.state = {
      ...
      preValue: defaultVal || [data[0].id],
      assistValue: defaultVal || [data[0].id],
    };
  }
  ...
  render() {
    const {
      modalFilter, modalAnimatedValue, assistValue,
    } = this.state;
    const {
      closeIcon,
      title,
    ...
    return (
      <View style={styles.containerStyle} testID="BottomModalSelect">
        {modalFilter ? (
          <View
                ...
                >
                  <ScrollView>
                    <ListCheckBox
                      ...
                      single={!multi}
                      checkBoxProps={{ textStyle: { color: '#333333' } }}
