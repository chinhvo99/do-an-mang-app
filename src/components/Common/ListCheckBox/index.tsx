...
import { CheckBox, CheckBoxProps as ECheckBoxProps } from 'react-native-elements';
  ...
  constructor(props: Props) {
    ...
    if (!_.isUndefined(defaultValue)) {
      ...
      defaultValue.forEach((d: any) => {
        ...
        valuesCopy[_.indexOf(dataExtract, d)].isChecked = !valuesCopy[_.indexOf(dataExtract, d)].isChecked;
      });
