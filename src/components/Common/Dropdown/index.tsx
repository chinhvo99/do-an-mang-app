  ...
  render() {
    ...
    return (
      <View>
                    ...
                    >
                      <Text
                        ...
                        value === item.value
                          ...
                          : { color: inActiveTextColor || theme.Dropdown.textColor }
                      }
                      >
                        {item.label}
                      </Text>
        ...
        {rotateIcon ? (
          <TouchableWithoutFeedback onPress={() => this.setState({ rotateIcon: !rotateIcon })}>
            <View style={{
              flex: 1,
              position: 'absolute',
              left: 0,
...
export default withTheme(Dropdown as unknown as React.ComponentType<Props & ThemeProps<any>>);
