...
class SliderEntry extends PureComponent<Props> {
  render() {
    ...
    return (
      ...
      >
        <View style={[styles.imageContainer, { backgroundColor: theme.AppModal.backgroundColor }]}>
          <Image
        ...
        {type !== 'image' ? (
          <View style={[styles.textContainer, { backgroundColor: theme.AppModal.backgroundColor }]}>
            { data.title ? (
              <Text
