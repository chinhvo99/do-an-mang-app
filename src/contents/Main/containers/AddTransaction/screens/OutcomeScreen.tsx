...
import {
  Dimensions,
  Keyboard, Platform, StyleSheet, TouchableOpacity,
} from 'react-native';
...
class OutcomeScreen extends PureComponent<Props, State> {
  amount: any;
  ...
  render() {
    ...
    return (
      <Container activeOpacity={1} onPress={() => Keyboard.dismiss()}>
        ...
        <Header title="Thêm chi tiêu" backIcon />
        <Body>
          <QuickView height="100%" column justifyContent="space-between">
            ...
            <QuickView justifyContent="center" flex={1}>
              ...
              <QuickView center width="50%" height="30%" row>
                <QuickView marginBottom={10} row>
                  <Text color={Color.red} fontSize={40} bold>-</Text>
                </QuickView>
                <Input
                  ...
                  inputStyle={{
                    fontSize: 25, color: Color.red, fontWeight: 'bold', margin: 0, paddingLeft: 0,
                  }}
              ...
              <QuickView
                ...
                alignItems="center"
                row
                style={{ borderWidth: 1, borderColor: Color.red }}
              >
                <QuickView flex={9}>
                  <Text color={Color.black}>{titleCategory}</Text>
                </QuickView>
                <QuickView flex={1}>
                  <Icon name="chevron-down" type="entypo" color={Color.red} />
                </QuickView>
              </QuickView>
            ...
            <QuickView>
              <Button
                ...
                paddingVertical={20}
                title="Thêm chi tiêu"
                icon={{ name: 'plus', type: 'antdesign', color: Color.red }}
                onPress={this.handleAddOutcome}
              />
